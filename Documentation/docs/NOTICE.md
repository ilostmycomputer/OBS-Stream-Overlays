...
`Overlays & Plugins/integrations/vencord/TypingNotifications/index.tsx` is a Vencord user-plugin
...
The OpenAI Sans font files beside the countdown in `Overlays & Plugins/overlays/countdown/` are
